...
import com.air.airspeed.NetInfo;
...
public class NetFileManager {
    ...
    private NetInfo parseDataNew(String sData) {
        ...
        netInfo.setLocalPort(strToInt(sSourceItem[1], 16, 0));
        ...
        netInfo.setRemotePort(strToInt(sDesItem[1], 16, 0));
    ...
    private void saveToMap(NetInfo netInfo) {
        ...
        processHost.put(netInfo.getLocalPort(), netInfo.getUid());
