    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter()) {
            ...
            if(olduser != null) {
                ...
                Boolean verifyPass = olduser.getPassword().equals(request.getParameter("Password"));
                if(verifyPass) {        
                    ...
                    newuser.setHeadPic(request.getParameter("HeadPic"));
        
                    modresult = UserDAO.updateUserHead(newuser);
                    ...
                    if(modresult > 0 ) {
                        ...
                        oprecord.setFieldName("HeadPic");
                        oprecord.setOldValue(olduser.getHeadPic());
                        oprecord.setNewValue(newuser.getHeadPic());
                        ...
                        if(recordresult > 0) {
                            ...
                            params.put("HeadPic", newuser.getHeadPic());
                        }else {
